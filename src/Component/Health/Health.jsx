      ...
      <div className="row">
        <div className="col-xs-6 col-sm-6 col-md-7">
          <p className="health-para">
            ...
            individuals, groups, corporate organisations and health facilities.
            We are dedicated to providing high quality and evidence-based
            nutrition and dietetic services to promote health, diagnose and
            treat diet-related conditions. Our diet therapy interventions and
            programmes are structured and outcomes-focused to ensure the best
      ...
      <div className="row">
        <div className="col-xs-6 col-sm-6 col-md-6">
          <ul>
            ...
            <li className="lists">Underweight or Unintentional weight loss</li>
